...
public class PartTimeEmployee extends Employee {
  ...
  public PartTimeEmployee(String employeeId, String name, double hourlyRate, double hoursWorked) {
    super(employeeId, name, hourlyRate); // hourlyRate を basePay として渡す
  ...
  public double calculateGrossPay() {
    return super.basePay * this.hoursWorked; // 時給 × 実働時間
  }
  ...
  public String getPaySlipDetails() {
    ...
    ap.accept("時給", fmt.format(super.basePay));
